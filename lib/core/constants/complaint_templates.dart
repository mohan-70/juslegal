...
1. Refund of ₹[Amount] paid for the product/service
2. Compensation of ₹[Amount] for mental agony and harassment
3. Litigation costs of ₹[Amount]
...
**Date of Incident:** [Incident Date]
**Time of Incident:** [Transaction Time]
**Amount Fraudulently Debited:** ₹[Amount]
...
2. That on [Incident Date], an unauthorized transaction of ₹[Amount] occurred.
...
**Relief Claimed:**
1. Refund of the unauthorized amount of ₹[Amount]
...
**Relief Claimed:**
1. Refund of ₹[Amount]
2. Compensation for harassment: ₹[Amount]
3. Litigation costs: ₹[Amount]
4. Any other relief
...
2. Was overcharged ₹[Amount] with fake GST
...
**Relief Claimed:**
1. Refund of excess amount: ₹[Amount]
...
**Relief Claimed:**
1. [Specific Relief 1]: ₹[Amount]
2. [Specific Relief 2]: ₹[Amount]
3. Legal costs: ₹[Amount]
