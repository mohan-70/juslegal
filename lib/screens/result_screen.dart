  ...
  void _saveCase(BuildContext context, WidgetRef ref) async {
    ...
    try {
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
              content: Text('Unable to save case. Please try again.')),
        );
      }
    }
  }
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: const Border(
                          left: BorderSide(
                              color: AppColors.justiceGold, width: 3)),
                      boxShadow: [
                        BoxShadow(
                  ...
                  ...List.generate(result.steps.length, (index) {
                    final isExpanded = index < _expandedSteps.length
                        ? _expandedSteps[index]
                        : false;
                    return Padding(
                      ...
                      child: GestureDetector(
                        ...
                        child: AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            color: isExpanded
                                ? AppColors.trustNavy.withOpacity(0.04)
                                : Colors.white,
                            borderRadius: BorderRadius.circular(16),
                            border: Border.all(
                              color: isExpanded
                  ...
                  Wrap(
                    ...
                    children: [
                      GestureDetector(
                        onTap: () => _showLawBottomSheet(
                            result.applicableLaw, result.lawSummary),
                        child: Container(
                  ...
                  child: OutlinedButton.icon(
                    ...
                    style: OutlinedButton.styleFrom(
                      side: const BorderSide(
                          color: AppColors.trustNavy, width: 1.5),
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(16),
                      ),
                    ),
